        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="bg-purple-50 rounded-lg p-4 mb-6">
            <p className="text-sm text-purple-900">
              ...
              Your responses will be analyzed by AI to generate insights that help create a better workplace.
            </p>
          </div>
          <p className="text-sm text-slate-500">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-white">
            ...
            <p className="text-purple-100">
              Hi {tokenData?.employeeName}, help us improve by sharing your feedback
            </p>
          </div>
                ...
                >
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={option.value} className="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex gap-6">
                    <div className="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition">
